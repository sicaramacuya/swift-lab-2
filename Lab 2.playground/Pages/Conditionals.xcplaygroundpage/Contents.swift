...
*/
func stringToEmojisPlus(word: String) -> Character {
    var moods: [String] = ["happy", "good", "okay", "awesome", "lit", "fun"]
    
//    This go over every mood in the moods array and check if the word pass as parameter matches any of those.
    for mood in moods {
        if word == mood {
            return "😀"
        }
